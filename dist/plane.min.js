...
`+t.getShaderInfoLog(r)),null)}};var R=class{constructor(){}update(t){}surfaceDidChange(t,i,s){}},E=class{constructor(){this.texture=null,this._opacity=1,this._rotation=[0,0,0],this._position=[0,0,0],this.mtrans=n(),this.mrot=n(),this._mMatrix=n(),this._pendingMatrixUpdates=!1,this.shader=new c}init(t){this.shader.init(t)}get position(){return this._position}set position(t){this.translate(t[0],t[1],t[2])}get opacity(){return this._opacity}set opacity(t=1){this._opacity=t}get hasTexture(){return this.texture!=null}get modelMatrix(){return this.updateMatrix(),this._mMatrix}rotate(t,i,s){(this._rotation[0]!=t||this._rotation[1]!=i||this._rotation[2]!=s)&&(this._rotation=[t,i,s],this.mrot=S([t,i,s]),this._pendingMatrixUpdates=!0)}translate(t,i,s){(this._position[0]!=t||this._position[1]!=i||this._position[2]!=s)&&(this._position=[t,i,s],this.mtrans=B([t,i,s]),this._pendingMatrixUpdates=!0)}updateMatrix(){this._pendingMatrixUpdates&&(this._mMatrix=u(this.mtrans,this.mrot),this._pendingMatrixUpdates=!1)}draw(t){}};var p=class extends E{constructor(){super();this.width=2,this.height=2,this.vertices=[],this._vbo_stride=5}init(t){super.init(t),this._vbo=t.createBuffer(),this.generateTriangles()}get triangleCount(){return this.vertices.length/3}generateTriangles(){this.vertices=[];let t=this.width/2,i=this.height/2;this.vertices.push([-t,-i,0,0,0]),this.vertices.push([t,-i,0,1,0]),this.vertices.push([t,i,0,1,1]),this.vertices.push([-t,i,0,0,1]),this.vertices.push([-t,-i,0,0,0]),this.vertices.push([t,i,0,1,1]),this.updateVBO()}updateGeometry(){this.generateTriangles()}updateVBO(){this._vbo_need_updates=!0}generateVBO(t){if(this._vbo_need_updates){this._vdata=new Float32Array(this.vertices.length*this._vbo_stride);let s=0;for(var i of this.vertices)this._vdata[s]=i[0],this._vdata[s+1]=i[1],this._vdata[s+2]=i[2],this._vdata[s+3]=i[3],this._vdata[s+4]=i[4],s+=this._vbo_stride;t.bindBuffer(t.ARRAY_BUFFER,this._vbo),t.bufferData(t.ARRAY_BUFFER,this._vdata,t.STATIC_DRAW),this._vbo_need_updates=!1}}draw(t){super.draw(t),this.generateVBO(t);var i;t.bindBuffer(t.ARRAY_BUFFER,this._vbo),t.vertexAttribPointer(0,3,t.FLOAT,!1,20,0),t.enableVertexAttribArray(0),t.vertexAttribPointer(1,2,t.FLOAT,!1,20,12),t.enableVertexAttribArray(1),t.drawArrays(t.TRIANGLES,0,this.vertices.length),t.disableVertexAttribArray(i)}};var g=class{constructor(t,i,s){this.gl=t,this.texture=new T,this.texture.init(this.gl,i,s),this.glBuffer=this.gl.createFramebuffer(),this.gl.bindFramebuffer(this.gl.FRAMEBUFFER,this.glBuffer),this.gl.framebufferTexture2D(this.gl.FRAMEBUFFER,this.gl.COLOR_ATTACHMENT0,this.gl.TEXTURE_2D,this.texture.glTexture,0)}},P=class extends c{constructor(){super()}get fragmentShader(){return`
            uniform vec2 resolution; 
            uniform sampler2D texture;
